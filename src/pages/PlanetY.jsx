...
<a className=' bg-slate-800 bg-opacity-40 p-12 text-l relative right-[42%] md:right-[44%] lg:right-[46%]  rounded-t-full  rotate-90 cursor-pointer z-10  text-center bottom-[4%] ' href='/PlanetX'>previous Planet!</a>
    </m.section>
  )
}
